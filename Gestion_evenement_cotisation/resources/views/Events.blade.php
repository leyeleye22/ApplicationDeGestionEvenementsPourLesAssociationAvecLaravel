...
@section('nav')
    <section>
        <div class="bg-light text-black py-8">
            <div class="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
                <div class="flex flex-col w-full sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 px-8">
                    <p class="ml-2 text-black-300 uppercase tracking-loose">Working Process</p>
                    ...
                    <p class="text-sm md:text-base text-black-50 mb-4">
                        Here’s your guide to the tech fest 2021 process. Go through all the steps to know the exact process
                        of the
                        fest.
                    </p>
                    <a href="#"
                        class="bg-transparent mr-auto hover:bg-black-300 text-black-300 hover:text-white rounded shadow hover:shadow-lg py-2 px-4 border border-black-300 hover:border-transparent">
                        Explore Now</a>
                </div>
                        ...
                        <div class="relative wrap overflow-hidden p-10 h-full">
                            ...
                            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                                ...
                                <div class="order-1 w-5/12 px-1 py-4 text-right">
                                    <p class="mb-3 text-base text-black-300">1-6 May, 2021</p>
                            ...
                            <div class="mb-8 flex justify-between items-center w-full right-timeline">
                                ...
                                <div class="order-1  w-5/12 px-1 py-4 text-left">
                                    <p class="mb-3 text-base text-black-300">6-9 May, 2021</p>
                            ...
                            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                                <div class="order-1 w-5/12"></div>
                                <div class="order-1 w-5/12 px-1 py-4 text-right">
                                    <p class="mb-3 text-base text-black-300"> 10 May, 2021</p>
                            ...
                            <div class="mb-8 flex justify-between items-center w-full right-timeline">
                                ...
                                <div class="order-1  w-5/12 px-1 py-4">
                                    <p class="mb-3 text-base text-black-300">12 May, 2021</p>
